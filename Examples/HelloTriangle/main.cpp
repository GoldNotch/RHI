...
int main()
{
  ...
  // set shaders
  trianglePipeline->AttachShader(RHI::ShaderType::Vertex, L"Shaders/triangle_vert.spv");
  trianglePipeline->AttachShader(RHI::ShaderType::Fragment, L"Shaders/triangle_frag.spv");
